...
namespace BuySell.Effects
{
    ...
    public static class TooltipEffect
    {
        ...
        public static readonly BindableProperty IsShowTooltipProperty =
          BindableProperty.CreateAttached("IsShowTooltip", typeof(bool), typeof(TooltipEffect), false);
        ...
        public static bool GetIsShowTooltip(BindableObject view)
        {
            if (view != null)
            {
                return (bool)view.GetValue(IsShowTooltipProperty);
            }
            else
            {
                return false;
        ...
        public static void SetIsShowTooltip(BindableObject view, bool value)
        {
            view.SetValue(IsShowTooltipProperty, value);
        }
    ...
    {
        public ControlTooltipEffect() : base("BuySell.TooltipEffect")
        {
